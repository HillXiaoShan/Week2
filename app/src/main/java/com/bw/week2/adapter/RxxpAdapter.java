...
public class RxxpAdapter extends RecyclerView.Adapter<RxxpAdapter.Holder> {
    ...
    public RxxpAdapter(List<MyBean.ResultBean.RxxpBean.CommodityListBean> list, Context context) {
        this.list = list;
    ...
    public Holder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_rxxp, null);
