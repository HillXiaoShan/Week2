...
public class MlshAdapter extends RecyclerView.Adapter<MlshAdapter.Holder> {
    List<MyBean.ResultBean.MlssBean.CommodityListBeanXX> list;
    Context context;

    public MlshAdapter(List<MyBean.ResultBean.MlssBean.CommodityListBeanXX> list, Context context) {
        this.list = list;
    ...
    public Holder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_mlsh, null);
